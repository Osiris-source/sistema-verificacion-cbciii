...
export interface ApiAmbienteAmbiente extends Struct.CollectionTypeSchema {
  collectionName: 'ambientes';
  info: {
    displayName: 'Ambiente';
    pluralName: 'ambientes';
    singularName: 'ambiente';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    escuela: Schema.Attribute.Relation<'manyToOne', 'api::escuela.escuela'>;
    estado: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    evaluaciones: Schema.Attribute.Relation<
      'oneToMany',
      'api::evaluacion.evaluacion'
    >;
    facultad: Schema.Attribute.Relation<'manyToOne', 'api::facultad.facultad'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    tipoAmbiente: Schema.Attribute.Enumeration<
      ['AULA', 'LABORATORIO', 'PABELLON']
    > &
      Schema.Attribute.Required;
...
export interface ApiChecklistChecklist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    evaluaciones: Schema.Attribute.Relation<
      ...
      'api::evaluacion.evaluacion'
    >;
    fechaVigencia: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    secciones: Schema.Attribute.Relation<'oneToMany', 'api::seccion.seccion'>;
    tipoAmbiente: Schema.Attribute.Enumeration<
      ['AULA', 'LABORATORIO', 'PABELLON']
    > &
      Schema.Attribute.Required;
...
export interface ApiEscuelaEscuela extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ambientes: Schema.Attribute.Relation<'oneToMany', 'api::ambiente.ambiente'>;
...
export interface ApiEvaluacionEvaluacion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ambiente: Schema.Attribute.Relation<'manyToOne', 'api::ambiente.ambiente'>;
    ambienteNumero: Schema.Attribute.String;
    checklist: Schema.Attribute.Relation<
      'manyToOne',
      'api::checklist.checklist'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    escuela: Schema.Attribute.String;
    estado: Schema.Attribute.Enumeration<['BORRADOR', 'FINALIZADO']>;
    facultad: Schema.Attribute.String;
    fechaEvaluacion: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::evaluacion.evaluacion'
    > &
      Schema.Attribute.Private;
    observacionesGenerales: Schema.Attribute.Text;
    porcentajeCumplimiento: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    respuestas: Schema.Attribute.Relation<
      'oneToMany',
      'api::respuesta.respuesta'
    >;
    sedeFilial: Schema.Attribute.String;
    totalAplicables: Schema.Attribute.Integer;
    totalConformes: Schema.Attribute.Integer;
    totalNoAplica: Schema.Attribute.Integer;
    totalNoConformes: Schema.Attribute.Integer;
    ubicacionAmbiente: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFacultadFacultad extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    escuelas: Schema.Attribute.Relation<'oneToMany', 'api::escuela.escuela'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPreguntaPregunta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    permiteEvidencia: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    publishedAt: Schema.Attribute.DateTime;
    requiereEvidenciaNoConforme: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    requiereObservacionNoConforme: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    respuestaConforme: Schema.Attribute.Enumeration<['SI', 'NO']>;
    respuestas: Schema.Attribute.Relation<
      'oneToMany',
      'api::respuesta.respuesta'
    >;
    seccion: Schema.Attribute.Relation<'manyToOne', 'api::seccion.seccion'>;
...
export interface ApiRespuestaRespuesta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    esConforme: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    evaluacion: Schema.Attribute.Relation<
      'manyToOne',
      'api::evaluacion.evaluacion'
    >;
    evidencias: Schema.Attribute.Media<'images' | 'files', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::respuesta.respuesta'
    ...
    publishedAt: Schema.Attribute.DateTime;
    respuesta: Schema.Attribute.Enumeration<['SI', 'NO', 'NO_APLICA']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSeccionSeccion extends Struct.CollectionTypeSchema {
...
export interface ApiSedeSede extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facultades: Schema.Attribute.Relation<
      'oneToMany',
      'api::facultad.facultad'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::ambiente.ambiente': ApiAmbienteAmbiente;
